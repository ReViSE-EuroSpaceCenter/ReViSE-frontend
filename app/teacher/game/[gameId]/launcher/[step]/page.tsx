    ...
    <div className="text-white font-sans px-6 py-8 max-w-6xl mx-auto space-y-8">
      ...
      <div className="flex justify-end">
        <button
          ...
          className="cursor-pointer rounded-lg bg-purpleReViSE px-6 py-3 text-lg text-white transition
                     hover:bg-purple-700 disabled:cursor-not-allowed disabled:opacity-50 shadow-lg"
        >
          Valider l{"'"}étape
        </button>
      </div>
